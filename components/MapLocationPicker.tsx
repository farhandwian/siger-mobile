  ...
  const handlePlaceSelect = (data: any, details: any) => {
    try {
      if (details?.geometry?.location) {
        ...
        console.warn("Place details do not contain valid geometry");
        Alert.alert(
          "Error",
          "Unable to get location details for the selected place."
        );
      }
    } catch (error) {
      ...
      <View style={styles.searchContainer}>
        <GooglePlacesAutocomplete
          ...
          query={{
            ...
            components: "country:id", // Restrict to Indonesia, remove if global search needed
          }}
          fetchDetails={true}
